...
public class ServicioComentariosTest {
	...
	public void getComentarioTest() {
		...
		given().expect().body("creador", equalTo("@marcialangton")).statusCode(200).when()
				.get("temas/84c23968-3b58-4f7c-8070-0f0146669394/1029284211918659584");
	}
	...
	public void crearTemaExistenteTest() {
		...
		given().expect().statusCode(500).when().post("temas/colorectal");
	...
	public void crearTemaNuevoTest() {
		...
		given().expect().statusCode(201).when().post("temas/lymphoma");
	}

	@Test
	public void buscarComentariosConsultaErroneaTest() {
		given().when().get("temas/search?since=null&cond=OR&cond=AND").then().assertThat().statusCode(400);
	}

	@Test
	public void buscarComentariosSinRespuestaTest() {
		given().when().get(
				"temas/search?tema=84c23968-3b58-4f7c-8070-0f0146669394&tema=14cdc884-f10b-48dd-9ec4-49c50e0060ce&cond=AND")
				.then().assertThat().statusCode(404);
	}

	@Test
	public void buscarComentariosCorrectoTest() {
		given().when().get("temas/search?tema=84c23968-3b58-4f7c-8070-0f0146669394").then().assertThat()
				.statusCode(200);
	}
}
